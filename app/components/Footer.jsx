    ...
    <div>
      <footer className="w-full  2sm:h-[409px] sm:h-[270px] relative flex justify-center items-center ">
        <div className="sm:h-[205px] 2sm:h-[280px] md:h-[200px] sm:w-[85%] md:w-[50%] 2sm:h-[203px] 2sm:w-[69%] sm:w-[313px] sm:h-[105px] relative flex  place-content-around 2sm:pt-[30px] sm:pt-[10px]">
          ...
          <Image src='/images/header-regulator.svg' alt="regulator" width={5} height={146} className='absolute -left-1.5 2sm:top-[96px] sm:top-[160px] 2sm:top-[170px] md:top-[90px] 2sm:w-[5] 2sm:h-[146px] sm:w-[5] sm:h-[45px]' />
          <Image src='/images/header-regulator.svg' alt="regulator" width={5} height={146} className='absolute -right-1.5 2sm:bottom-[96px] sm:bottom-[160px] 2sm:bottom-[170px] md:bottom-[90px] 2sm:w-[5] 2sm:h-[146px] sm:w-[5] sm:h-[45px]' />
          ...
          {/* Block 2  */}
            <ul className="flex flex-col 2sm:h-[134px] sm:h-[80px] gap-1.5 ">
              <h2 className="font-VcrMono tracking-[1.95px] uppercase 2sm:text-sm sm:text-[12px] sm:hidden 2sm:hidden md:block  text-[#73E338]">gorillas’</h2>
              ...
              <Link className="font-VcrMono 2sm:tracking-[1.5px] sm:tracking-[0.75px] z-50 uppercase 2sm:text-[10px] sm:text-[8px] text-white" href="/portfolio/industries">
                ...
                <h2 className="font-VcrMono 2sm:text-sm sm:text-[12px] sm:mt-[12px] tracking-[1.95px] sm:block 2sm:block md:hidden uppercase text-[#73E338] ">contact</h2>
                <Link className="font-VcrMono z-50  2sm:tracking-[1.5px] sm:tracking-[0.75px] 2sm:text-[10px] sm:block 2sm:block md:hidden sm:text-[8px] uppercase text-sx text-white" href="#">
                +995 557 46 04 06
                </Link>
                <Link className="font-VcrMono z-50 2sm:tracking-[1.5px] sm:tracking-[0.75px] uppercase 2sm:text-[10px] sm:block 2sm:block md:hidden sm:text-[8px]  text-white" href="#">
                +995 593 50 88 48
                </Link>
                <Link className="font-VcrMono z-50  2sm:tracking-[1.5px] sm:tracking-[0.75px] uppercase 2sm:text-[10px] sm:block 2sm:block md:hidden sm:text-[8px] text-white" href="#">
          ...
          {/* Block 3 */}
            <ul className="flex flex-col 2sm:h-[134px]  sm:h-[80px] gap-[4.7px] ">
              <h2 className="font-VcrMono tracking-[1.95px]  uppercase 2sm:text-sm sm:text-[8px] sm:hidden 2sm:hidden md:block text-[#73E338]">connect</h2>
              ...
              <h2 className="font-VcrMono 2sm:text-sm sm:text-[8px] tracking-[1.95px] md:mt-[11px] sm:hidden 2sm:hidden md:block uppercase text-[#73E338] ">contact</h2>
              <Link className="font-VcrMono z-50  2sm:tracking-[1.5px] sm:tracking-[0.75px] sm:hidden 2sm:hidden md:block 2sm:text-[10px] sm:text-[5px] uppercase text-sx text-white" href="#">
              +995 557 46 04 06
              </Link>
              <Link className="font-VcrMono z-50 2sm:tracking-[1.5px] sm:tracking-[0.75px] sm:hidden 2sm:hidden md:block uppercase 2sm:text-[10px] sm:text-[5px]  text-white" href="#">
              +995 593 50 88 48
              </Link>
              <Link className="font-VcrMono z-50  2sm:tracking-[1.5px] sm:tracking-[0.75px] sm:hidden 2sm:hidden md:block uppercase 2sm:text-[10px] sm:text-[5px] text-white" href="#">
              info@gorillasproduction.ge
            ...
            <div className="absolute 2sm:right-11 2sm:top-8 sm:right-[9%] sm:top-20 2sm:right-[10%] 2sm:top-24 md:right-[5%] md:top-10 ">
                <Image src="/images/logo.svg" alt="footer-logo-foto" width={50} height={50} className="2sm:w-[50px] 2sm:h-[50px] sm:w-[48px] sm:h-[48px] 2sm:w-[98px] 2sm:h-[98px] md:w-[68px] md:h-[68px]"/>
            </div>
          {/* </div> */}
        </div>
