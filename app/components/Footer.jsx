...
const Footer = () => {
  return (
    <footer className="w-full mt-96 h-[605px]  mb-10  flex flex-col gap-16 justify-center items-center">
      <div className="pb-5 mt-20 relative flex">
        ...
        <div className="flex flex-row gap-20">
          <ul className="flex flex-col gap-5 pt-5 pl-20 whitespace-nowrap">
            ...
            <Link className="text-sx z-10" href="#">
              social media{" "}
            </Link>
          </ul>
          ...
          <ul className="flex flex-col gap-5 pt-5 pr-5">
            ...
            <Link className="text-sx mt-2" href="#">
            +995 557 46 04 06
            </Link>
            <Link className="text-sx mt-2" href="#">
            +995 593 50 88 48
            </Link>
            <Link className="text-sx mt-2 z-10" href="#">
      ...
      <Image
        ...
        height={100}
         ...
         />
         <h1 className="font-sm">Gorillas’   pRODUCTION</h1>
      </div>
