  ...
  const Header = () => {
    ...
    return (
      <div className="w-full h-auto flex  justify-center relative">
        <div
          className={`top-[53px] w-9/12 h-[520px] relative overflow-hidden ${
            hovered ? "" : "backdrop-blur-3xl"
          } transition-backdrop-filter duration-5000 ease-in`}
        ...
        >
          ...
          <p className=" whitespace-nowrap  absolute top-8 right-9 font-VcrMono text-6xl text-[#73E338]">
            OUR TEAM
          </p>
