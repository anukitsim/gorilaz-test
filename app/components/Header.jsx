  ...
  useEffect(() => {
    ...
    folders.forEach((folder, index) => {
      folder.addEventListener("mouseenter", () => {
        ...
        const translateYValue = links.length * 15;
      ...
      <div className="top-[53px] w-9/12 h-[622.696px] relative overflow-hidden videoContainer">
        ...
        <div className="absolute left-10 top-52 ">
          <div className="relative">
            ...
            <div
              className="arrow w-[55.19px] h-[16.307px] bg-[#565656] rounded-tl-[36.75px] rounded-tr-[0] rounded-br-[0] 
                rounded-bl-[0] z-[999] absolute -top-4 left-[190px] flex items-center justify-end pr-1"
            >
          ...
          <div className="folder z-40   w-[246.068px] h-[244.339px] flex justify-center flex-shrink-0 border border-solid border-[#565656] rounded-tl-[15px] rounded-tr-[0.3px] rounded-br-[5px] rounded-bl-[5px] bg-[#181818] absolute bottom-[27px]">
            ...
            <div className="arrow w-[55.19px] h-[16.307px]  bg-[#565656] rounded-tl-[15px] z-[999] absolute -top-4 left-[189px] flex items-center justify-end pr-1">
              <Image src="/images/arrow.svg" alt="logo" width={20} height={0} />
            </div>
            <p className="absolute left-5 top-4 text-[10px] text-white">06</p>
            <Link
              href="#"
              className="absolute left-9 top-3 text-[15px] text-[#73E338] font-VcrMono"
            >
              BLOG
            </Link>
          </div>
          ...
          <div className="folder z-30  w-[246.068px] h-[244.339px] flex justify-center flex-shrink-0 border border-solid border-[#565656] rounded-tl-[15px] rounded-tr-[0.3px] rounded-br-[5px] rounded-bl-[5px] bg-[#181818] absolute bottom-[54px]">
            ...
            <div className="arrow w-[55.19px] h-[16.307px]  bg-[#565656] rounded-tl-[15px] z-[999] absolute -top-4 left-[190px] flex items-center justify-end pr-1">
              <Image src="/images/arrow.svg" alt="logo" width={20} height={0} />
            </div>
          ...
          <div className=" folder z-20  w-[246.068px] h-[244.339px] flex justify-center flex-shrink-0 border border-solid border-[#565656] rounded-tl-[15px] rounded-tr-[0.3px] rounded-br-[5px] rounded-bl-[5px] bg-[#181818] absolute bottom-[81px]">
            ...
            <Link
              href="#"
              className="absolute left-9 top-3 text-[15px] flex flex-col gap-1 text-[#73E338] font-VcrMono"
            >
              WHAT WE DO
            </Link>
            <div className="sublinks">
              <Link
                href="#"
                className="absolute left-9 top-10 text-[10px] text-[#fff] flex flex-col  font-VcrMono "
              >
                process
              </Link>
              <Link
                href="#"
                className="absolute left-9 top-[55px] text-[10px] text-[#fff] flex flex-col  font-VcrMono "
              >
              services
              </Link>
              <Link
                href="#"
                className="absolute left-9 top-[70px] text-[10px] text-[#fff] flex flex-col  font-VcrMono "
              >
               photography
              </Link>
              <Link
                href="#"
                className="absolute left-9 top-[85px] text-[10px] text-[#fff] flex flex-col  font-VcrMono "
              >
               videography
              </Link>
              <Link
                href="#"
                className="absolute left-9 top-[100px] text-[10px] text-[#fff] flex flex-col  font-VcrMono "
              >
               location scouting
              </Link>
              <Link
                href="#"
                className="absolute left-9 top-[115px] text-[10px] text-[#fff] flex flex-col  font-VcrMono "
              >
          ...
          <div className="folder z-[5]  w-[246.068px] h-[244.339px] flex justify-center flex-shrink-0 border border-solid border-[#565656]  flex-col rounded-tl-[15px] rounded-tr-[0.3px] rounded-br-[5px] rounded-bl-[5px] bg-[#181818] absolute bottom-[135px]">
            ...
            <Link
              href="#"
              className="absolute left-9 top-3 text-[15px] text-[#73E338] flex flex-col gap-1 font-VcrMono "
            >
              GORILAS'
            </Link>
            <div className="sublinks">
          ...
          <div className="folder z-[1]  w-[246.068px] h-[244.339px] flex justify-center flex-shrink-0 border border-solid border-[#565656] rounded-tl-[15px] rounded-tr-[0.3px] rounded-br-[5px] rounded-bl-[5px] bg-[#181818] absolute bottom-[162px]">
            {/* Add content for the third folder here */}
            <div className="arrow w-[55.19px] h-[16.307px]  bg-[#565656] rounded-tl-[15px] z-[999] absolute -top-4 left-[190.5px] flex items-center justify-end pr-1">
              <Image src="/images/arrow.svg" alt="logo" width={20} height={0} />
            </div>
