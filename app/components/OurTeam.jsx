...
const OurTeam = () => {
  ...
  return (
    <>
<div className="w-[20%]  absolute h-[1px] max-[1300px]:top-[120%] max-[1900px]:top-[120%] max-[1470px]:top-[190%] right-0  bg-white md:block sm:hidden"></div>
<div className="w-[20%]  absolute h-[1px] max-[1300px]:top-[120%] max-[1900px]:top-[120%] max-[1470px]:top-[190%] bg-white md:block sm:hidden"></div>
